...
parser.add_argument('source',nargs='?', help='directory of images', type=str, default='sgtu')
parser.add_argument('outdir', type=str, nargs='?', help="out directory to save masked iris", default='outs640')
parser.add_argument('weights',nargs='?', help='weights path', type=str, default='models/yolov8s-seg-640.pt')
